...
class Introduction(Page):
    ...
    def vars_for_template(self):
        return {
            'crash_death_chance': self.session.config['crash_death_chance'],
            'swerve_death_chance': self.session.config['swerve_death_chance'],
        }
    pass
...
class Decision(Page):
    ...
    def vars_for_template(self):
        ...
        return {
            ...
            'my_payoffs_adv_1_total': [p.payoff_vs_adv_1 for p in me.in_all_rounds()[:-1]],
            ...
            'adv_1_payoffs_total': [p.payoff_of_adv_1 for p in me.in_all_rounds()[:-1]],
            ...
            'my_payoffs_adv_2_total': [p.payoff_vs_adv_2 for p in me.in_all_rounds()[:-1]],
            'adv_2_decision_total': [p.decision_of_adv_2 for p in me.in_all_rounds()[:-1]],
            'adv_2_payoffs_total': [p.payoff_of_adv_2 for p in me.in_all_rounds()[:-1]],
    ...
    def before_next_page(self):
        ...
        if me.adv_2_type == 'human': #if adv = human
            ...
            if me.round_number == 1: # cooperate in round one (can change)
                me.decision_of_adv_2 = 'Swerve'
            else:
                if me.in_round(last_round).decision_vs_adv_2 == 'Defect': #no max arg needed because it's nested if that isn't round 1
                    me.decision_of_adv_2 = 'Swerve' #if player defects, adv defects
                else:
                    me.decision_of_adv_2 = 'Straight'
...
class Results(Page):
    ...
    def vars_for_template(self):
        ...
        return {
            ...
            'my_payoffs_adv_1_total': [p.payoff_vs_adv_1 for p in me.in_all_rounds()],
            'my_payoff_adv_1': me.payoff_vs_adv_1,
            'adv_1_decision': me.decision_of_adv_1,
            'adv_1_payoff': me.payoff_of_adv_1,
            'adv_1_payoffs_total': [p.payoff_of_adv_1 for p in me.in_all_rounds()],
            'my_decision_adv_2': me.decision_vs_adv_2,
            ...
            'adv_2_decision': me.decision_of_adv_2,
            'adv_2_payoff': me.payoff_of_adv_2,
            'adv_2_payoffs_total': [p.payoff_of_adv_2 for p in me.in_all_rounds()],
            'my_payoffs_adv_2_total': [p.payoff_vs_adv_2 for p in me.in_all_rounds()],
