...
class PlayerBot(Bot):
    ...
    def play_round(self):
        ...
        yield (pages.Experience, {    'years_military_experience': 50,                   'game_theory_experience': 1, 'machine_learning_experience': 1})
